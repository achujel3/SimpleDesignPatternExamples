...
/**
 * A Template Method Pattern contains a method that provides the steps of the algorithm. It allows
...
public abstract class Hoagie {
    ...
    /**
     * Thes are called hooks
     * <p>
     * If the user wants to override these they can
     * <p>
     * Use abstract methods when you want to force the user to override and use a hook when you want
     * it to be optional
     */
