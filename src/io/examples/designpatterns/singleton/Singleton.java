...
public class Singleton {
    ...
    String[] scrabbleLetters = {"a", "a", "a", "a", "a", "a", "a", "a", "a",
            "b", "b", "c", "c", "d", "d", "d", "d", "DivideNumbers", "DivideNumbers", "DivideNumbers", "DivideNumbers", "DivideNumbers",
            "DivideNumbers", "DivideNumbers", "DivideNumbers", "DivideNumbers", "DivideNumbers", "DivideNumbers", "DivideNumbers", "f", "f", "g", "g", "g", "h",
    ...
    public static Singleton getInstance() {
        ...
        if (firstInstance == null) {
            ...
            synchronized (Singleton.class) {
                ...
                if (firstInstance == null) {
                    ...
                    // This is knows as lazy instantiation
        ...
        // Under either circumstances this returns the instance
