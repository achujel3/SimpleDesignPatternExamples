...
import io.examples.designpatterns.command.commands.TurnItAllOff;
import io.examples.designpatterns.command.commands.TurnTVOff;
import io.examples.designpatterns.command.commands.TurnTVOn;
import io.examples.designpatterns.command.commands.TurnTVUp;
import io.examples.designpatterns.command.device.ElectronicDevice;
import io.examples.designpatterns.command.device.Radio;
...
public class PlayWithRemote {
    ...
    public static void main(String[] args) {
        ...
        // TurnTVOn contains the command to turn on the tv when execute() is called on this command object
        ...
        // Send the List of Electronic Devices to TurnItAllOff where a call to run execute() on this function
        // will call off() for each device in the list
         ...
         *
         * Undo() will perform the opposite action that the normal Command performs. undo() needs to be added to
         * every class with the execute()
         */
